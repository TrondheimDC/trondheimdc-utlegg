...
| i18n            | react-i18next (Norwegian/English)                                     |
...
pnpm dlx serve output        # Start production server
...
- `react-i18next` with `useTranslation`; translation keys in dot notation, e.g. `t("section.key")`
